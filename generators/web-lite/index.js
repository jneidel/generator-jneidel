...
module.exports = genGenerator( { long: "node webapp (lite)", short: "app" }, {
  ...
  dotfiles  : [ "gitignore" ],
  files     : [ "app.js", "error-handlers.js", "user-model.js", "webpack.config.js", "src/bundles/welcome.bundle.js", "src/js/welcome.js", "src/scss/welcome.scss", "src/scss/_vars.scss", "src/scss/layout.scss", "src/pug/login.pug", "src/pug/register.pug", "src/pug/error.pug", "logs/utils.js", "logs/logger.js", "public/favicon.ico", "vars.env.example" ],
