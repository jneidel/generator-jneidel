...
describe( "generator-jneidel", () => {
  describe( "jneidel:node", () => {
    ...
    it( "creates files", () => {
      assert.file( [ ".travis.yml", ".gitignore", ".editorconfig", "index.js", "license", "test.js", "readme.md", "package.json", "todo.md", ".npmrc" ] );
    } );
  } );
  ...
  describe( "jneidel:chrome", () => {
    ...
    it( "creates files", () => {
      assert.file( [ ".travis.yml", ".gitignore", ".editorconfig", "webpack.config.js", "license", "vars.env", "readme.md", "package.json", "todo.md", "dist/img/icon.png", "src/js/background.js", "src/js/options.js", "src/scss/options.scss", "src/bundles/options.bundle.js", "src/pug/options.pug", "test/test.test.js", "dist/manifest.json", ".npmrc" ] );
    } );
  } );
  ...
  describe( "jneidel:static", () => {
    ...
    it( "creates files", () => {
      assert.file( [ ".travis.yml", ".gitignore", ".editorconfig", "webpack.config.js", "license", "vars.env", "vars.env.example", "readme.md", "package.json", "todo.md", "src/js/index.js", "src/scss/index.scss", "src/bundles/index.bundle.js", "src/pug/index.pug", "test.js", ".npmrc" ] );
    } );
  } );
  ...
  describe( "jneidel:cli", () => {
    ...
    it( "creates files", () => {
      assert.file( [ ".travis.yml", ".gitignore", ".editorconfig", "license", "lib/index.js", "lib/log.js", "test/index.test.js", "lib/commands.js", "bin/cli.js", "readme.md", ".npmrc" ] );
    } );
  } );
