...
describe( "generator-jneidel", () => {
  ...
  describe( "jneidel:chrome", () => {
    ...
    it( "creates files", () => {
      assert.file( [ ".travis.yml", ".gitignore", ".npmrc", ".editorconfig", "webpack.config.js", "licence", "vars.env", "readme.md", "package.json", "todo.md", "dist/img/icon.png", "src/js/background.js", "src/js/options.js", "src/scss/options.scss", "src/bundles/options.bundle.js", "src/pug/options.pug", "test/test.test.js", "dist/manifest.json" ] );
    } );
  } );
